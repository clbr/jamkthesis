...
other words, fastest to calculate. Two options were tested: the default S-shaped activation 
function, hyperbolic tangent; and an adaptation from the graphics world, Perlin's 
smootherstep function, converted to use fixed-point mathematics.
