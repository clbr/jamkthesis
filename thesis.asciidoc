...
around, and deleted, the memory space becomes increasingly fragmented.
...
GPU to finish its current work, plus the PCI-E bus latency. The delay caused by a VRAM 
