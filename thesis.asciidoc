...
The current network constants are stored in a header file, magic.h, which can be dropped in 
to the runtime implementation for easy updates.

Sample output from the benchmark mode:
----
