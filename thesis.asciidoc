...
while MLP is said to perform better. MLP is also covered more in literature.
...
.Example of a labeled dataset for supervised learning.
image::pics/labeled.jpg[scaledwidth="100%"]
...
With a single hidden layer chosen, the big question is how to choose the amount of hidden 
