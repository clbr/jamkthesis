...
giving it an accuracy of ~0.0078. The best half of the population was alloved to survive
...
During the initial attemps it became clear that a solution with this amount of nodes could 
...
image::pics/indres384.png[scaledwidth="75%"]

.Major results in 512 mb.
image::pics/indres512.png[scaledwidth="75%"]
...
In total, about 60 GB of data was collected.
