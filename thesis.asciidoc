...
of various styles, based on the ioquake3 engine. VDrift is a driving simulator. Xonotic is a 
...
In the results above, for most tests improvements of 1-2% can be seen. There were three 
regressions: Smoking Guns 
0.2%, Tremulous 0.3%, and Urban Terror 10.2%. The first two can be considered as noise given 
...
expected. Still, in the end, a satisfactory solution was found.
