...
*gettimeofday*() function, which has an accuracy of approximately 70 ns on modern computers.
...
moved to C++ for easy access to the *multimap* data structure.
...
the tested critter, or in the Monte-Carlo modes, the score of the round.
