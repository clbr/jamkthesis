...
cases, and it would be constantly tweaked to accomodate newly discovered pathological cases. 
There is no existing model, and no single right answer to the question "how important is
this buffer?".
